...
import GestionDeQuizes from "./Pages/Admin/GestionDeQuizes";
import ResumenUsuario from "./Pages/Admin/ResumenUsuario"
      ...
      <BrowserRouter>
        <Routes>
          ...
          >
            ...
            <Route path="/usuarios/:usuarioId" element={<ResumenUsuario />} />
          </Route>
